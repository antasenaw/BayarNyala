      ...
      <main className="flex flex-col grow mx-8 gap-8">
        ...
        <section className="flex gap-8 max-md:flex-col">
          ...
          <div className="basis-0 grow flex flex-col min-h-full">
            ...
            <div className="text-gray-600 rounded-2xl flex flex-col basis-0 grow gap-4 border p-3 border-gray-400 overflow-y-auto shadow-xl [scrollbar-width:none] [&::-webkit-scrollbar]:hidden">
