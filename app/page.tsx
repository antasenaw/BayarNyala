        ...
        <main className="flex flex-col h-full w-full justify-center gap-4 pl-24">
          ...
          <div className="flex text-xl gap-4 font-semibold">
            <Link
              ...
              href='/login'
              className="bg-blue-600 text-white flex items-center gap-2 shadow-xl py-4 px-8 rounded-2xl border border-gray-300 hover:scale-105 active:scale-95 transition-all duration-300 ease-in-out"
            >Masuk{loading === 'loading1' && SpinnerSVG}</Link>
            <Link
              onClick={() => {
                setLoading('loading2');
              }}
              href='/signup'
              className="bg-white text-blue-600 flex items-center gap-2 shadow-xl py-4 px-8 rounded-2xl border border-blue-600 hover:scale-105 active:scale-95 transition-all duration-300 ease-in-out"
            >Daftar{loading === 'loading2' && SpinnerSVG}</Link>
          </div>
        </main>
      </div>
    </>
