...
export async function getPenyewa (): Promise<IPenyewaDetails[]> {
...
export async function postKamar(newKamarData: IPenyewaDetails): Promise<APIResponse> {
...
export async function editKamar(kamarId: string, updateData: IPenyewaDetails): Promise<APIResponse> {
    const endpoint = `/api/kamar/${kamarId}`;
...
export async function getKamarById(kamarId: string): Promise<APIResponse> {
    ...
    try {
        ...
        return { 
            success: true, 
            data: result.data as IPenyewaDetails,
